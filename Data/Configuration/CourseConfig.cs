...
namespace CodeFirstMigration.Data.Configuration
{
    internal class CourseConfig : IEntityTypeConfiguration<Course>
    {
        public void Configure(EntityTypeBuilder<Course> builder)
        {
            ...
            builder.Property(x=>x.CourseName).//varchar(250) not null
                HasColumnType("VARCHAR").HasMaxLength(250).IsRequired();

            builder.Property(x => x.Price).HasPrecision(15,2);// decimal (15,2)
            builder.ToTable("Courses");


            builder.HasData(LoadCourses());// insert data in table 
        }
